...
CREATE TABLE `heart` (
  ...
  CONSTRAINT `heart_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`),
  CONSTRAINT `heart_ibfk_2` FOREIGN KEY (`reviewid`) REFERENCES `review` (`no`)
...
INSERT INTO `heart` VALUES (1,2,1),(2,6,1),(3,8,1),(4,1,2),(5,10,2),(6,4,3),(7,5,3),(8,6,3),(9,7,4),(10,9,5);
